...
int idx;
    ...
    fKnobNoise->setValue(0.6f);
    fKnobBass->setValue(0.5f);
    fKnobMid->setValue(0.5f);
    fKnobTreble->setValue(0.5f);
    fKnobPresence->setValue(0.5f);
    fKnobContour->setValue(0.5f);
    fKnobMaster->setValue(0.5f);
    fKnobGain->setValue(0.5f);

    fSwitchBright->setDown(0.0f);

    fSwitchNoise->setDown(0.0f);

    fSwitchBoost->setDown(0.0f);
